...
export const SessionChat = forwardRef<SessionChatRef, SessionChatProps>(({ 
  ...
  `📎 Uploaded ${uploadResult.uploaded_files.length} file(s): ${uploadResult.uploaded_files.map((f: { filename: string }) => f.filename).join(', ')}. Please click 'Index Documents' to chat with them.`,
  'assistant'
)
